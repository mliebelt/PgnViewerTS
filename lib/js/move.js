...
var PgnMove = (function () {
    function PgnMove(fig, col, row, notation, disc, strike, moveNumber, commentBefore, commentAfter, commentMove, previousMove, nags, check) {
    ...
    PgnMove.buildMove = function (params) {
        var cm = new PgnMove(params.fig, params.col, params.row, params.notation, params.disc, params.strike, params.moveNumber, params.commentBefore, params.commentAfter, params.commentMove, params.previousMove, params.nags, params.check);
        return cm;
    };
    return PgnMove;
}());
