...
var PgnMove = (function () {
    ...
    PgnMove.buildMove = function (params) {
        var cm = new PgnMove(params.fig, params.col, params.row, params.notation, params.disc, params.strike, params.moveNumber, params.promotion, params.commentBefore, params.commentAfter, params.commentMove, params.previousMove, params.nags, params.check);
        return cm;
    };
    return PgnMove;
}());
