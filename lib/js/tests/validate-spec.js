...
describe("PGN validate", function () {
    ...
    xdescribe("sloppy moves", function () {
    ...
    xdescribe("move numbers", function () {
    ...
    xdescribe("variations", function () {
        xit("read variations", function () {
            // read normal variations
        });
        xit("with move numbers", function () {
            // check the held move numbers
        });
        xit("without move numbers", function () {
            // check the computed move numbers as well
        });
    }); // End of describe "PGN validate variations"
    xdescribe("NAGs", function () {
        xit("understand special symbols (like !, ??, ...", function () {
        });
        xit("understand $-notation", function () {
        });
    }); // End of describe "PGN validate NAGs"
    describe("special moves", function () {
        xit("should understand castling", function () {
            // all possible castling notations
        });
        xit("should understand en passent (no special notation for it)", function () {
