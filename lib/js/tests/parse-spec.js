...
describe("PGN parsing", function () {
    ...
    describe("comments", function () {
        it("should show all possible comments of one move", function () {
    ...
    describe("disabmbiguation", function () {
        // Disabmbiguation
    ...
    describe("strange formats", function () {
        it("should understand long notation", function () {
        ...
        it("should understand long notation without dash", function () {
    ...
    describe("special moves", function () {
        ...
        xit("should understand promotions", function () {
