...
describe("PGN generating an array of moves", function () {
    ...
    it("should have set nextMove and previousMode in moves", function () {
    ...
    it("should have variations generated", function () {
    ...
    it("should read two variations", function () {
    ...
    it("should read complex games", function () {
    ...
    it("should read mix of comments and variations", function () {
    ...
    it("should ignore result of game as move and hold as result", function () {
...
//# sourceMappingURL=generate-moves-spec.js.map