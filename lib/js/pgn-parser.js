...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c5 = function(cm, mn, cb, hm, nag, ca, vari, all) { var arr = (all ? all : []);
            var move = hm; move.turn = 'w'; move.moveNumber =  (mn ? mn : null);
            move.commentBefore = cb; move.commentAfter = ca; move.commentMove = cm;
      ...
      peg$c6 = function(cm, me, cb, hm, nag, ca, vari, all) { var arr = (all ? all : []);
            var move = hm; move.turn = 'b'; move.moveNumber = me;
